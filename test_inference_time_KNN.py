...
def test_knn_inference_time(model_path, input_shape=(3, 224, 224), num_runs=100):
    """Test inference time for KNN model
    Args:
...
if __name__ == "__main__":
    ...
    parser.add_argument("--config", type=str, default="exps/knn.json")
    parser.add_argument("--model_path", type=str, default="saved_pth/knn/model_2.pkl")
