...
class Finetune(BaseLearner):
    ...
    def _init_train(self, train_loader, test_loader, optimizer, scheduler):
        ...
        for _, epoch in enumerate(prog_bar):
            ...
            # if epoch + 1 == 268:
        torch.save(self._network.convnet, "checkpoints/init_train/resnet18_42871.pth")
        torch.save(self._network.fc, "checkpoints/init_train/fc_42871.pth")
