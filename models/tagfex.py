...
class TagFex(BaseLearner):
    ...
    def incremental_train(self, data_manager):
        ...
        self.test_loader = DataLoader(
            test_dataset, batch_size=self.args['batch_size'], shuffle=False, num_workers=self.args['num_workers'], pin_memory=True
        )
    ...
    def _init_train(self, train_loader, test_loader, optimizer, scheduler):
        ...
        for _, epoch in enumerate(prog_bar):
            ...
            for i, (_, inputs1, inputs2, targets) in enumerate(train_loader):
                inputs1, inputs2, targets = inputs1.to(self._device), inputs2.to(self._device), targets.to(self._device, non_blocking=True, dtype=torch.int64)
